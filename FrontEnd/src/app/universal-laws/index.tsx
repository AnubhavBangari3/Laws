  ...
  const universalLaws: UniversalLaw[] = [
    {
      ...
      meaning:
        "Everything in the universe is connected. Every thought and action affects the collective whole.",
      example: "Sending love raises not only your vibration but also others'.",
    },
    {
      id: 2,
      title: "Law of Vibration",
      meaning:
        "Everything vibrates at a frequency — thoughts, emotions, and matter.",
      example:
        "Feeling gratitude attracts more experiences that match that vibration.",
    },
    {
      id: 3,
      ...
      example:
        "Thinking ‘I always meet kind people’ attracts kindness in your reality.",
    },
    {
      id: 4,
      title: "Law of Inspired Action",
      meaning:
        "Manifestation requires aligned action based on intuition.",
      example:
        "Visualizing your dream job and then acting on a sudden idea to reach out on LinkedIn.",
    },
    {
      id: 5,
      title: "Law of Cause and Effect",
      meaning:
        "Every action has a reaction; energy you send returns.",
    ...
    },
    {
      ...
      meaning:
        "You are rewarded in proportion to the energy and value you give.",
    ...
    },
    {
      ...
      meaning:
        "Nothing is good or bad — everything is relative and helps growth.",
    ...
    },
    {
      ...
      meaning:
        "Everything has an opposite — light/dark, success/failure.",
    ...
    },
    {
      ...
      title: "Law of Rhythm",
      meaning:
        "Life flows in cycles — seasons, emotions, and growth.",
    ...
    },
    {
      ...
      title: "Law of Gender",
      meaning:
        "Everything has masculine (action) and feminine (intuition) energies.",
    ...
    },
    {
      ...
      example:
        "Thanking the universe for small blessings attracts bigger ones.",
    },
    {
      id: 14,
      title: "Law of Belief",
    ...
    },
    {
      ...
      meaning:
        "Let go of how or when desires manifest — trust divine timing.",
      example:
        "Applying for your dream job, then releasing the outcome — it arrives unexpectedly.",
    },
  ];
